...

{
    ...
    QString windowTitle = tr("SEND Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    annAction = new QAction(QIcon(":/icons/notepad"), tr("Announcement"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SEND Core"), this);
    aboutAction->setStatusTip(tr("Show information about SEND Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SEND"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SEND addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SEND addresses"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SEND Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SEND network", "", count));
}
...
{
    QString strTitle = tr("SEND Core"); // default title
