...
#   c) node1 mines 32 blocks, so now node 0 has 60001 send, node 1 has 4250 send, node2 has none.
#   d) node0 sends 601 send to node2, in two transactions (301 send, then 300 send).
